...
(function() {
	...
	enchant.nineleap = { assets: ['./images/start.png', './images/end.png', './images/clear.png'] };	// change 2019-04-21
        ...
        initialize: function(width, height) {
            ...
            this.addEventListener('load', function() {
              ...
              this.pushScene(this.startScene);
                ...
                // add 2019-04-21 *****************************************
                this.clearScene = new enchant.nineleap.SplashScene();
